...
def decrypt():
    ...
    if password == "1234":
        ...
        image_icon = PhotoImage(file="sadge-pray.png")
...
def main_screen():
    ...
    Label(text="Enter secret key for encryption and decrytpion", fg="black", font=("calibri", 13)).place(x=10, y=170)
    
    code = StringVar()
    Entry(textvariable=code, width=19, bd=0, font=("arial", 25),show="*").place(x=10, y=200)
    
    Button(text="ENCRYPT", height=2, width=23, bg="#ed3833", fg="white", bd=0, command=encrypt).place(x=10, y=250)
    Button(text="DECRYPT",height=2, width=23, bg="#00bd56", fg="white", bd=0, command=decrypt).place(x=188, y=250)
    Button(text="RESET", height=2, width=49, bg="#1089ff", fg="white", bd=0, command=reset).place(x=10, y=300)
